...
test('PAGINAS incluye las 8 páginas del sitio', () => {
  assert.deepEqual(PAGINAS.map((p) => p.archivo), [
    'index.html', 'torneos.html', 'resultados.html', 'ranking.html', 'jugadores.html', 'records.html', 'cara-a-cara.html', 'nosotros.html',
  ]);
});
